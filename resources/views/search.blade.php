...
<!--ボタン-->
<div class="mb-2 p-1">
    <button onclick="location.href='{{ url('/thread/post')}}'" class="border w-full px-2 py-2 bg-orange-500 text-lg text-white font-semibold rounded hover:bg-orange-400">スレッド作成</button>
</div>
